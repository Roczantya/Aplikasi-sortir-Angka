...
void main() {
  ...
  // Stopwatch untuk menghitung waktu eksekusi
  ...
  // Menampilkan durasi eksekusi
  print(
      'Waktu yang dibutuhkan untuk proses: ${stopwatch.elapsedMilliseconds} ms');

  // Cetak piramida dari hasil operasi
  print('Piramida dari hasil operasi:');
  printPyramid(hasil);

  print('Piramida dari hasil operasi(dari kecil ke besar):');
